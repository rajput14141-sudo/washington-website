    ...
    <div className="page-shell">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8 max-w-2xl">
          <p className="mb-2 text-xs font-black uppercase tracking-[0.2em] text-teal-700">
            Wash packages
          </p>
          ...
          <p className="mt-3 text-base leading-7 text-slate-600">
            Professional care, transparent pricing, and convenient doorstep service.
          </p>
        </div>
        ...
        <div className="grid items-stretch gap-4 sm:grid-cols-2 xl:grid-cols-3">
          {services.map((s) => (
            <article
              key={s.id}
              className="group flex flex-col rounded-lg border border-slate-200 bg-white p-5 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-teal-200 hover:shadow-xl hover:shadow-slate-900/10 sm:p-6"
            >
              <div>
              ...
              <h3 className="mt-5 text-xl font-extrabold leading-7 text-slate-950">
                {s.name}
              </h3>
              ...
              <div className="mt-5 flex items-center justify-between gap-4 border-t border-slate-100 pt-4">
                <p className="min-w-0 truncate text-xl font-black text-teal-800">
                  {formatPrice(s.price)}
                </p>
